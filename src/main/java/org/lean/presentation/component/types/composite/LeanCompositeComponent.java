 ...
 *     of the composite.
 *     <p>
 * @see LeanCompositeComponent#getExpectedSize(LeanPresentation, LeanPage, LeanComponent,
 *     IDataContext, IRenderContext, LeanLayoutResults)
...
public class LeanCompositeComponent extends LeanBaseComponent implements ILeanComponent {
  ...
  public void render(
    ...
    for (int i = 0; i < children.size(); i++) {
      ...
      LeanComponentLayoutResult childComponentLayoutResult =
          new LeanComponentLayoutResult(layoutResult);
