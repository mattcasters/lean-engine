...
public class TestUtil {
  ...
  public static void assertEqualPresentations(
      LeanPresentation presentation, LeanPresentation verify) {
  ...
  public static void assertEqualConnectors(
      LeanConnector originConnector, LeanConnector verifyConnector) {
  ...
  public static void assertEqualsComponents(
      LeanComponent originComponent, LeanComponent verifyComponent) {
